...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//acceso a traves del setter a un atributo que es privado
		p.setEdad(20);
		//acceso directamente a un atributo publico
		p.nombre="";
		//es inaccesible por que la herencia no funciona desde nodos superiores a inferiores
		//no hay acceso a miembro de nodos inferiores desde nodos superiores
		//p.trabajar();
		...
		//protected permite usar las variables en el mismo paquete 
